...
export const ingredients: Record<string, Ingredient> = {
  ...
  'recipe-savory-popcorn-bucket': {
    id: 'recipe-savory-popcorn-bucket',
    name: 'Savory Popcorn Bucket',
    source: 'crafted',
    cost: null,
    dailyLimit: null,
    notes: 'Crafted recipe used as ingredient in Savory Double Combo Bucket',
  },
  'recipe-caramel-popcorn-bucket': {
    id: 'recipe-caramel-popcorn-bucket',
    name: 'Caramel Popcorn Bucket',
    source: 'crafted',
    cost: null,
    dailyLimit: null,
    notes: 'Crafted recipe used as ingredient in Sweet Duo Bucket',
  },
  'recipe-salsa-wavy-potato-chips': {
    id: 'recipe-salsa-wavy-potato-chips',
    name: 'Salsa Wavy Potato Chips',
    source: 'crafted',
    cost: null,
    dailyLimit: null,
    notes: 'Crafted recipe used as ingredient in combo buckets',
  },
  'recipe-romaine-lettuce-taco': {
    id: 'recipe-romaine-lettuce-taco',
    name: 'Romaine Lettuce Taco',
    source: 'crafted',
    cost: null,
    dailyLimit: null,
    notes: 'Crafted recipe used as ingredient in Wild Vegetable Celtuce Taco',
  },
  'recipe-springday-fruit-black-tea': {
    id: 'recipe-springday-fruit-black-tea',
    name: 'Springday Fruit Black Tea',
    source: 'crafted',
    cost: null,
    dailyLimit: null,
    notes: 'Crafted recipe used as ingredient in movie combos',
  },
  'recipe-sweet-duo-bucket': {
    id: 'recipe-sweet-duo-bucket',
    name: 'Sweet Duo Bucket',
    source: 'crafted',
    cost: null,
    dailyLimit: null,
    notes: 'Crafted recipe used as ingredient in Colorful Movie Combo',
  },
  'recipe-savory-double-combo-bucket': {
    id: 'recipe-savory-double-combo-bucket',
    name: 'Savory Double Combo Bucket',
    source: 'crafted',
    cost: null,
    dailyLimit: null,
    notes: 'Crafted recipe used as ingredient in Supreme Movie Meal',
  },
};
